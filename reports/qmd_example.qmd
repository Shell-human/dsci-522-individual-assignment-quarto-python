...
![Figure 1: Horse populations for all provinces in Canada from 1906 - 1972.](../results/horse_pops_plot.png)
...
([Van Rossum and Drake 2009] for statistical calculations).

Additionally, note that in Table 1 we consider the sample standard deviation of the number of horses during the same time span as Figure 1 ([@horses1], [@horses2]).

![Figure 2: Horse populations for the province with the largest standard deviation ([@horses1]).](../results/horse_pops_plot_largest_sd.png)



In Figure 2 we zoom in and look at the province of `{largest_sd}`, which had the largest spread of values in terms of standard deviation ([@horses2]).
