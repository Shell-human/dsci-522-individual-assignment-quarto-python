...
![Horse populations for all provinces in Canada from 1906 - 1972.](../results/horse_pops_plot.png)
...
![Horse populations for the province with the largest standard deviation ([@horses1]).](../results/horse_pops_plot_largest_sd.png)
